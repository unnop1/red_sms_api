...
public interface ByResponseTimeRepo extends JpaRepository<SmsGatewayEntity,Long> {
    ...
    @Query(value =  """
                    ...
                    GROUP BY TRUNC(smsgw.created_date, 'YEAR'), TRUNC(smsgw.created_date, 'MONTH'), TRUNC(smsgw.created_date, 'DD'), smsgw.order_type_mainid, config_conditions_id, smsgw.transaction_id, smsgw.phonenumber, smsgw.ordertype, smsgw.receive_date, smsgw.send_date, smsgw.is_status, conf.refid 
    ...
    // /* BY MONTH USE WITH BY_ORDERTYPE */
    @Query(value =  """
                    SELECT 
                    TO_CHAR(TRUNC(smsgw.created_date, 'YEAR'), 'YYYY') AS YEAR_ONLY,
                    TO_CHAR(TRUNC(smsgw.created_date, 'MONTH'), 'MON') AS MONTH_ONLY,
                    ...
                    """
                    ,nativeQuery = true)
    public List<ResponseTimeMonth> ListByResponseTimeMonth(
        @Param(value = "ordertype_main_id") Long orderTypeMainID,
        @Param(value = "start_time")Timestamp startTime,
        @Param(value = "end_time")Timestamp endTime
    );
